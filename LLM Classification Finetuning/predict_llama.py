...
try:
    from human_pref.models.modeling_llama import LlamaForSequenceClassification # type: ignore
    ...
    LlamaForSequenceClassification = None
    ProcessorPAB = None
    LMSYSDataset = None
    VarlenCollator = None
...
possible_checkpoints = [
    ...
    "checkpoints/lmsys-checkpoints-3-0805"
]
...
if not os.path.exists(csv_path):
    print("test_swap.parquet not found. Please run prepare_datasets.py.")
    exit(1)
