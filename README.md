...
| 5 | [**Connect X**](./Competitions/Connect%20X/README.md)<br><sub>A Minimax game-playing agent using Alpha-Beta pruning and heuristic board evaluation for the Connect Four simulation.</sub> | 🥉 | [Open](https://www.kaggle.com/code/ameythakur20/connectx-minimax-alpha-beta-agent) |
...
| 12 | [**Kaggriculture**](./Competitions/Kaggriculture/README.md)<br><sub>An industrial livestock and predictive market-order prioritization engine in a two-player simulation.</sub> | 🥉 | [Open](https://www.kaggle.com/code/ameythakur20/kaggriculture-premium-first-market-agent) |
...
| 16 | [**Predict Customer Churn**](./Competitions/Predict%20Customer%20Churn/README.md)<br><sub>A gradient boosting ensemble pipeline combining Optuna-tuned XGBoost, LightGBM, and CatBoost with extensive feature engineering.</sub> | 🥉 | [Open](https://www.kaggle.com/code/ameythakur20/customer-churn-prediction-121-fe-20-cv-stacking) |
| 17 | [**Predicting Smartphone Addiction**](./Competitions/Predicting%20Smartphone%20Addiction/README.md)<br><sub>A gradient boosting ensemble pipeline combining Optuna-tuned algorithms with a constrained SLSQP metric-optimised meta-ensemble for binary behavioural classification.</sub> |  | [Open](https://www.kaggle.com/code/ameythakur20/predicting-smartphone-addiction) |
| 18 | [**Stanford RNA 3D Folding Part 2**](./Competitions/Stanford%20RNA%203D%20Folding%20Part%202/README.md)<br><sub>Structural Biology Pipeline Optimization</sub> |  | [Open](https://www.kaggle.com/code/ameythakur20/stanford-rna-3d-folding-part-2-tbm-protenix-v1) |
| 19 | [**Student Study Hours to CGPA Prediction**](./Competitions/Student%20Study%20Hours%20to%20CGPA%20Prediction/README.md)<br><sub>Predict academic performance using polynomial regression and regularized ensembles.</sub> |  | [Open](https://www.kaggle.com/code/ameythakur20/student-study-hours-to-cgpa-prediction) |
| 20 | [**Titanic - Machine Learning from Disaster**](./Competitions/Titanic%20-%20Machine%20Learning%20from%20Disaster/README.md)<br><sub>A deterministic historical record linkage approach aligning passenger manifests with ground-truth survival records.</sub> | 🥉 | [Open](https://www.kaggle.com/code/ameythakur20/titanic-passenger-survival-prediction) |
| 21 | [**Triagegeist**](./Competitions/Triagegeist/README.md)<br><sub>A reliable three-tier clinical decision support system using a blended meta-ensemble and uncertainty-aware safety logic for ESI triage.</sub> |  | [Open](https://www.kaggle.com/code/ameythakur20/triagegeist-cdss-multi-tier-acuity-forecasting) |
...
**8 bronze medals** &nbsp;·&nbsp; **highest rank 886** of 61,329
